...
class REST::AccountSerializer < ActiveModel::Serializer
  ...
  attributes :id, :username, :acct, :display_name, :locked, :bot, :discoverable, :group, :created_at,
             :note, :url, :uri, :avatar, :avatar_static, :avatar_missing, :header, :header_static,
  ...
  def avatar
    return full_asset_url('/avatars/original/legacy-raven-v3.png') if avatar_missing
